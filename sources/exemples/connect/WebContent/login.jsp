...
<body>
	...
	<div class="container">
		...
		<form class="form-signin"
			...
			<label for="pseudo" class="sr-only">Pseudonyme</label> <input
				id="ipseudo" class="form-control" placeholder="Pseudonyme"
				name="login" required autofocus> <br />
			<button class="btn btn-lg  btn-success btn-block" type="submit">S'authentifier</button>
			<p>Vérifier via votre outils de developpement la présence du
				JSESSION_ID, c'est lui qui nous permettra à Tomcat de reconnaitre la
