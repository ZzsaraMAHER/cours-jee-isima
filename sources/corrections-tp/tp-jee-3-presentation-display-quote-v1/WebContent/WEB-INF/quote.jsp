		...
		<div class="jumbotron">
			...
			<div class="btn-group" role="group">
				<c:choose>
					...
					<c:otherwise>
						<a role="button"
							href="${pageContext.request.contextPath}/displayQuote?quoteNumber=${quote.firstIndex}"
				...
				<c:choose>
					<c:when test="${quote.hasPrevious}">
						<a role="button"
							href="${pageContext.request.contextPath}/displayQuote?quoteNumber=${quote.previousIndex}"
				...
				<c:choose>
					<c:when test="${quote.hasNext}">
						<a role="button"
							href="${pageContext.request.contextPath}/displayQuote?quoteNumber=${quote.nextIndex}"
				...
				<c:choose>
					...
					<c:otherwise>
						<a role="button"
							href="${pageContext.request.contextPath}/displayQuote?quoteNumber=${quote.lastIndex}"
