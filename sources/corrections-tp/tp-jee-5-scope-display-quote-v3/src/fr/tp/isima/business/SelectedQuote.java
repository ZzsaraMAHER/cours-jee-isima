...
/**
 * La citation selectionnée : on retrouve la citation est les directions
...
public class SelectedQuote {
    ...
    private Direction next() {
        // Pour plus de compréhension, nous n'allons pas chainer les appel
        // ici
        // On commence pas la base on passe la navigation modélisée et la
        // quote
        // selectionnee
        final DirectionBuilder directionBuilder = new DirectionBuilder(NavigationDirection.NEXT);
        // Ensuite on appelle la méthode hasNext
    ...
    private Direction previous() {
        // le fait de chainer des appels comme ça se nomme
        // une fluent API
    ...
    // le builder va nous permettre de constuire les directions de façons
    // elegantes.
