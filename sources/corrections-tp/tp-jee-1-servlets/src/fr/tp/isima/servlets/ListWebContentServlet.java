 ...
 * rappelant cette servlet (il faudra peut-être redemarré le Tomcat, dans ce cas
 * là dans votre vue serveur après le Started, vous verrez un "Restart")
 * </p>
 * <p>
 * <b>Attention</b> il s'agit d'une copie. Ce qui est déployé n'est pas le
 * WebContent que vous pouvez voir dans Eclipse sur votre projet. Si vous créez
 ...
 * de votre Eclipse. Vous pouvez surcharger la méthode
 * {@link HttpServlet#init()} pour le vérifier.
 * </p>
 * <ul>
